...
tabla <- tabla %>% filter(zona== 'ET Colegiales')
#Tabla Principal
...
library(readxl)
Copia_de_Monitoreo_Social_CEAMSE_Responses_ <- read_excel("Copia de Monitoreo Social CEAMSE (Responses).xlsx", 
                                                          sheet = "Sheet4")
View(Copia_de_Monitoreo_Social_CEAMSE_Responses_)
